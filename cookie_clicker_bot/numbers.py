...
class Multiplier(Enum):
    ...
    duodecillion = auto()
    tredecillion = auto()
    quattuordecillion = auto()
    quindecillion = auto()
    sexdecillion = auto()
    septendecillion = auto()
    octodecillion = auto()
    novemdecillion = auto()
    vigintillion = auto()
    unvigintillion = auto()
    duovigintillion = auto()
    tresvigintillion = auto()
    quattuorvigintillion = auto()
    quinvigintillion = auto()
    sesvigintillion = auto()
    septemvigintillion = auto()
    octovigintillion = auto()
    novemvigintillion = auto()
    trigintillion = auto()
    untrigintillion = auto()
    duotrigintillion = auto()
    googl = auto()
    trestrigintillion = auto()
    quadragintillion = auto()
    quinquagintillion = auto()
    sexagintillion = auto()
    septuagintillion = auto()
    octogintillion = auto()
    nonagintillion = auto()
    centillion = auto()
